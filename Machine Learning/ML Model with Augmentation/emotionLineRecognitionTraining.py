...
def main():
    ...
    # 2. DATASET LOADING
    # -------------------------------------------------------------------------
    # If you only have a single folder of 3403 images, you can do a random split here.
    data_dir = 'data'
    full_dataset = datasets.ImageFolder(data_dir, transform=data_transforms)
    
    # Split dataset into 80% training and 20% validation.
    total_size = len(full_dataset)  # ~3403 images
    val_size = int(0.2 * total_size)  # ~680 images
    train_size = total_size - val_size
    
    train_dataset, val_dataset = random_split(full_dataset, [train_size, val_size])
    # Override the validation dataset's transform to the val_transforms
